      ...
      if (root) {
        _this.subscription = model.$.mergeMap(function (version) {
          ...
          if ((0, _isPlainObject2["default"])(pathsAsArrayOrObject)) {
            paths = (0, _utils.toPaths)(pathsAsArrayOrObject);
          }
          if ((0, _isArray2["default"])(pathsAsArrayOrObject)) {
          ...
          return _Observable.Observable.fromPromise(model.get.apply(model, _toConsumableArray(paths)));
